...
- f34a111: Align the SDK with the July 31 2026 Factus v2 docs sync (payroll numbering ranges, XML downloads, catalog updates).
...
- 591a5cc: Align the SDK with the July 2026 Factus v2 docs sync for debit notes, electronic payroll, and payroll elimination notes.
...
- f705557: Migrate `factus-js` from Factus API v1 to Factus API v2.
