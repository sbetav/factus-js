...
Este endpoint `devuelve` el xml de la nota débito en formato **Base64** y el nombre del archivo asociado.
...
```
https://api-sandbox.factus.com.co/v2/debit-notes/:number/download-xml
```

**Producción**

```
https://api.factus.com.co/v2/debit-notes/:number/download-xml
```
...
[Sección titulada «Variables de Ruta, Path Variables»](https://developers.factus.com.co/notas-debito/descargar-xml#variables-de-ruta-path-variables)
