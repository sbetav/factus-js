...
El archivo adjunto corresponde al archivo zip que contiene el pdf de la nota débito y el attached document que se enviaría en el correo oficial.
...
```
https://api-sandbox.factus.com.co/v2/debit-notes/:number/email-content
```

**Producción**

```
https://api.factus.com.co/v2/debit-notes/:number/email-content
```
...
[Sección titulada «Variables de Ruta, Path Variables»](https://developers.factus.com.co/notas-debito/obtener-contenido-de-correo#variables-de-ruta-path-variables)
