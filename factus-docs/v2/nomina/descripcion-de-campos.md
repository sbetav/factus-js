...
Esta sección describe los campos que puede contener la nómina electrónica.
...
```
https://api-sandbox.factus.com.co/v2/payroll/validate
```

**Producción**

```
https://api.factus.com.co/v2/payroll/validate
```
...
### Estructura para crear la nómina

[Sección titulada «Estructura para crear la nómina»](https://developers.factus.com.co/nomina/descripcion-de-campos#estructura-para-crear-la-n%C3%B3mina)

Para crear una nómina debemos tener en cuenta los datos agrupados en 4 aspectos:

1. Datos generales de la nómina
2. Periodo de liquidación
3. Datos del trabajador
4. Devengados y deducciones

### Parámetros del Cuerpo (Body)

[Sección titulada «Parámetros del Cuerpo (Body)»](https://developers.factus.com.co/nomina/descripcion-de-campos#par%C3%A1metros-del-cuerpo-body)

El cuerpo (Body) de la solicitud debe enviarse en formato JSON e incluir los siguientes parámetros:
...
El (\*) al lado del nombre de un campo indica que se pueden enviar múltiples objetos con esa estructura dentro del array.
