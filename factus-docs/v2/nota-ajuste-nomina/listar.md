...
Este endpoint `devuelve` una lista de nóminas de eliminación.
...
[Sección titulada «Filtros de Búsqueda»](https://developers.factus.com.co/nota-ajuste-nomina/listar#filtros-de-b%C3%BAsqueda)
...
##### El endpoint devuelve información paginada de las nóminas de eliminación, incluyendo:

[Sección titulada «El endpoint devuelve información paginada de las nóminas de eliminación, incluyendo:»](https://developers.factus.com.co/nota-ajuste-nomina/listar#el-endpoint-devuelve-informaci%C3%B3n-paginada-de-las-n%C3%B3minas-de-eliminaci%C3%B3n-incluyendo)

* **Total**: Total de nóminas de eliminación encontradas.
