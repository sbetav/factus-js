...
- Generated at: 2026-07-17T03:34:53.630Z
- Base URL: https://developers.factus.com.co/
- Files: 94

## Autenticación

- Source: https://developers.factus.com.co/autenticacion/auth
- File: autenticacion\auth.md

## Introducción a la autenticación

- Source: https://developers.factus.com.co/autenticacion/introduccion
- File: autenticacion\introduccion.md

## Refresh Token

- Source: https://developers.factus.com.co/autenticacion/refresh-token
- File: autenticacion\refresh-token.md

## Cambios de V1 a V2

- Source: https://developers.factus.com.co/buenas-practicas/cambios-v2-v1
- File: buenas-practicas\cambios-v2-v1.md

## Conceptos para la creación de facturas

- Source: https://developers.factus.com.co/buenas-practicas/primeros-pasos
- File: buenas-practicas\primeros-pasos.md

## Colección de Factus API v2
...
- Source: https://developers.factus.com.co/documentos-soporte/descargar-pdf
- File: documentos-soporte\descargar-pdf.md

## Descargar XML

- Source: https://developers.factus.com.co/documentos-soporte/descargar-xml
...
- Source: https://developers.factus.com.co/documentos/descargar-xml
- File: documentos\descargar-xml.md
...
- Source: https://developers.factus.com.co/facturas/aceptacion-tacita
- File: facturas\aceptacion-tacita.md

## Crear y validar

- Source: https://developers.factus.com.co/facturas/crear-y-validar
- File: facturas\crear-y-validar.md

## Descargar PDF

- Source: https://developers.factus.com.co/facturas/descargar-pdf
- File: facturas\descargar-pdf.md

## Descargar XML AttachedDocument

- Source: https://developers.factus.com.co/facturas/descargar-xml-attacheddocument
- File: facturas\descargar-xml-attacheddocument.md

## Descargar XML

- Source: https://developers.factus.com.co/facturas/descargar-xml
...
- Source: https://developers.factus.com.co/facturas/obtener-contenido-de-correo
...
- Source: https://developers.factus.com.co/facturas/tipos-de-factura/estandar
- File: facturas\tipos-de-factura\estandar.md

## 11 - Mandatos

- Source: https://developers.factus.com.co/facturas/tipos-de-factura/mandatos
- File: facturas\tipos-de-factura\mandatos.md

## SS CUDE

- Source: https://developers.factus.com.co/facturas/tipos-de-factura/ss-cude
- File: facturas\tipos-de-factura\ss-cude.md

## SS CUFE

- Source: https://developers.factus.com.co/facturas/tipos-de-factura/ss-cufe
- File: facturas\tipos-de-factura\ss-cufe.md

## SS NUM

- Source: https://developers.factus.com.co/facturas/tipos-de-factura/ss-num
- File: facturas\tipos-de-factura\ss-num.md

## SS Recaudo

- Source: https://developers.factus.com.co/facturas/tipos-de-factura/ss-recaudo
- File: facturas\tipos-de-factura\ss-recaudo.md

## SS Reporte

- Source: https://developers.factus.com.co/facturas/tipos-de-factura/ss-reporte
- File: facturas\tipos-de-factura\ss-reporte.md

## SS Sin Aporte

- Source: https://developers.factus.com.co/facturas/tipos-de-factura/ss-sin-aporte
- File: facturas\tipos-de-factura\ss-sin-aporte.md
...
- Source: https://developers.factus.com.co/glosario
- File: glosario.md

## Introducción a Factus API

- Source: https://developers.factus.com.co/
- File: index.md

## Obtener datos de adquirientes

- Source: https://developers.factus.com.co/informacion-adquirientes/obtener-datos-adquiriente
- File: informacion-adquirientes\obtener-datos-adquiriente.md

## Introducción a Factus API

- Source: https://developers.factus.com.co/limite-de-request
- File: limite-de-request.md

## Manejo de respuestas API FACTUS

- Source: https://developers.factus.com.co/manejo-errores
- File: manejo-errores.md
...
- Source: https://developers.factus.com.co/notas-ajuste-documentos-soporte/descargar-pdf
- File: notas-ajuste-documentos-soporte\descargar-pdf.md

## Descargar XML

- Source: https://developers.factus.com.co/notas-ajuste-documentos-soporte/descargar-xml
...
- Source: https://developers.factus.com.co/notas-credito/crear-y-validar
- File: notas-credito\crear-y-validar.md

## Descargar PDF

- Source: https://developers.factus.com.co/notas-credito/descargar-pdf
- File: notas-credito\descargar-pdf.md

## Descargar XML AttachedDocument

- Source: https://developers.factus.com.co/notas-credito/descargar-xml-attacheddocument
- File: notas-credito\descargar-xml-attacheddocument.md

## Descargar XML

- Source: https://developers.factus.com.co/notas-credito/descargar-xml
...
- Source: https://developers.factus.com.co/notas-credito/enviar-correo
...
- Source: https://developers.factus.com.co/recepcion-de-documentos/cargar-factura
- File: recepcion-de-documentos\cargar-factura.md

## Emitir Evento

- Source: https://developers.factus.com.co/recepcion-de-documentos/emitir-evento
- File: recepcion-de-documentos\emitir-evento.md

## Ver Facturas

- Source: https://developers.factus.com.co/recepcion-de-documentos/ver-facturas
- File: recepcion-de-documentos\ver-facturas.md

## Respuestas del API

- Source: https://developers.factus.com.co/respuestas-del-api
- File: respuestas-del-api.md

## Suscripciones

- Source: https://developers.factus.com.co/suscripciones/suscripciones
...
- Source: https://developers.factus.com.co/tablas-de-referencia/unit-measures
- File: tablas-de-referencia\unit-measures.md
