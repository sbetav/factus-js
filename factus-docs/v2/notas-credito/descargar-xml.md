...
Este endpoint `devuelve` el xml de la nota crédito en formato **Base64** y el nombre del archivo asociado.
...
* [Sandbox](https://developers.factus.com.co/notas-credito/descargar-xml#tab-panel-60)
* [Producción](https://developers.factus.com.co/notas-credito/descargar-xml#tab-panel-61)
...
[Sección titulada «Variables de Ruta, Path Variables»](https://developers.factus.com.co/notas-credito/descargar-xml#variables-de-ruta-path-variables)
