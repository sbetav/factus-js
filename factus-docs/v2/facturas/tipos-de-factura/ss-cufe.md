...
Esta sección describe los campos que podría contener la factura electrónica del sector salud con tipo de operación **SS-CUFE**.

**Método:** POST

#### **Endpoint**

* [Sandbox](https://developers.factus.com.co/facturas/tipos-de-factura/ss-cufe#tab-panel-119)
* [Producción](https://developers.factus.com.co/facturas/tipos-de-factura/ss-cufe#tab-panel-120)
...
[Sección titulada «Ejemplo de Solicitud»](https://developers.factus.com.co/facturas/tipos-de-factura/ss-cufe#ejemplo-de-solicitud)

* [SS CUFE](https://developers.factus.com.co/facturas/tipos-de-factura/ss-cufe#tab-panel-121)
