...
Este endpoint `devuelve` un pdf de la factura en formato **Base64** y el nombre del archivo asociado.
...
* [Sandbox](https://developers.factus.com.co/facturas/descargar-pdf#tab-panel-26)
* [Producción](https://developers.factus.com.co/facturas/descargar-pdf#tab-panel-27)
...
[Sección titulada «Variables de Ruta, Path Variables»](https://developers.factus.com.co/facturas/descargar-pdf#variables-de-ruta-path-variables)
