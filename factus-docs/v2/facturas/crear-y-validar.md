...
* [Sandbox](https://developers.factus.com.co/facturas/crear-y-validar)
* [Producción](https://developers.factus.com.co/facturas/crear-y-validar)
...
[Sección titulada «Ejemplo de Solicitud»](https://developers.factus.com.co/facturas/crear-y-validar#ejemplo-de-solicitud)

* [Factura de venta](https://developers.factus.com.co/facturas/crear-y-validar)
...
[Sección titulada «Respuesta»](https://developers.factus.com.co/facturas/crear-y-validar#respuesta)

Descripción de los campos en la respuesta Campos Base
