...
El endpoint devuelve un pdf del documento soporte en formato **Base64** y el nombre del archivo asociado. Para utilizar el archivo, deberás decodificar el contenido de la propiedad `pdf_base_64_encoded`.
...
[Sección titulada «Variables de Ruta, Path Variables»](https://developers.factus.com.co/documentos-soporte/descargar-pdf#variables-de-ruta-path-variables)
