...
* [Sandbox](https://developers.factus.com.co/documentos-soporte/ver-y-filtrar#tab-panel-326)
* [Producción](https://developers.factus.com.co/documentos-soporte/ver-y-filtrar#tab-panel-327)
...
[Sección titulada «Filtros de Búsqueda»](https://developers.factus.com.co/documentos-soporte/ver-y-filtrar#filtros-de-b%C3%BAsqueda)
...
| **`filter[number]`**
Filtra por el número de documento soporte. |
| **`filter[prefix]`**
...
[Sección titulada «El endpoint devuelve información paginada de los documentos soporte, incluyendo:»](https://developers.factus.com.co/documentos-soporte/ver-y-filtrar#el-endpoint-devuelve-informaci%C3%B3n-paginada-de-los-documentos-soporte-incluyendo)
