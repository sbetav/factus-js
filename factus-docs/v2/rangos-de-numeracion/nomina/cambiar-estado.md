...
```
https://api-sandbox.factus.com.co/v2/numbering-ranges/payrolls/:numbering_range_id/toggle-status
```

**Producción**

```
https://api.factus.com.co/v2/numbering-ranges/payrolls/:numbering_range_id/toggle-status
```
...
[Sección titulada «Variables de Ruta, Path Variables»](https://developers.factus.com.co/rangos-de-numeracion/nomina/cambiar-estado#variables-de-ruta-path-variables)
...
[Sección titulada «Response»](https://developers.factus.com.co/rangos-de-numeracion/nomina/cambiar-estado#response)
