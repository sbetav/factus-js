...
[Sección titulada «Parámetros del Cuerpo (Body)»](https://developers.factus.com.co/rangos-de-numeracion/facturacion/crear-rango#par%C3%A1metros-del-cuerpo-body)
...
|
| **`resolution_number`** `Máx.4 caracteres`

Número de resolución del rango de numeración en la DIAN.
**NOTA**: Este campo es obligatorio para facturas y documentos soporte.
...
[Sección titulada «Response»](https://developers.factus.com.co/rangos-de-numeracion/facturacion/crear-rango#response)
