...
```
https://api.factus.com.co/v1/credit-notes/:number/email-content
```
...
[Sección titulada «Variables de Ruta (Path Variables)»](https://developers.factus.com.co/v1/notas-credito/obtener-contenido-de-correo#variables-de-ruta-path-variables)
