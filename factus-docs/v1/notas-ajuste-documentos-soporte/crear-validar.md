...
```
https://api.factus.com.co/v1/adjustment-notes/validate
```
...
```
{ "status": "Conflict", "message": "Se encontró una nota de ajuste pendiente por enviar a la DIAN"}
```

**Status 422**

```
{ "status": "Validation error", "message": "Error de validación", "data": { "message": "Error de validación", "errors": { "reference_code": [ "El campo código de referencia es obligatorio." ], "support_document_id": [ "El campo support document id es obligatorio." ] } }}
```
