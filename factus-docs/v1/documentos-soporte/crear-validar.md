...
```
https://api.factus.com.co/v1/support-documents/validate
```
...
```
{ "status": "Conflict", "message": "Se encontró un documento soporte por enviar a la DIAN"}
```

**Status 422**

```
{ "status": "Validation error", "message": "Error de validación", "data": { "message": "Error de validación", "errors": { "reference_code": [ "El campo código de referencia es obligatorio." ], "provider.address": [ "El campo dirección es obligatorio." ] } }}
```
