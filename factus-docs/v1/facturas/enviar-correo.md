...
* [Pruebas](https://developers.factus.com.co/v1/facturas/enviar-correo#tab-panel-178)
* [Producción](https://developers.factus.com.co/v1/facturas/enviar-correo#tab-panel-179)
...
[Sección titulada «Variables de Ruta (Path Variables)»](https://developers.factus.com.co/v1/facturas/enviar-correo#variables-de-ruta-path-variables)
...
[Sección titulada «Parámetros del Cuerpo (Body)»](https://developers.factus.com.co/v1/facturas/enviar-correo#par%C3%A1metros-del-cuerpo-body)
...
[Sección titulada «Ejemplo de Solicitud»](https://developers.factus.com.co/v1/facturas/enviar-correo#ejemplo-de-solicitud)

Aquí tienes un ejemplo de cómo debería quedar el cuerpo de la solicitud en formato JSON:

* [200 - Envío de correo](https://developers.factus.com.co/v1/facturas/enviar-correo#tab-panel-180)
...
* [status 200](https://developers.factus.com.co/v1/facturas/enviar-correo#tab-panel-181)
