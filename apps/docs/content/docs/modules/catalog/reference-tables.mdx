...
// Código numérico para la API (p. ej. identification_document_id)
const docType = IdentityDocumentTypeId.CitizenshipId.value; // 3

// Abreviatura habitual (p. ej. etiquetas en UI)
const abbr = IdentityDocumentTypeId.CitizenshipId.abbreviation; // "CC"
```
