...
```ts
import { CreditNoteOperationTypeCode, CreditNoteOperationTypeCodeInfo } from "factus-js";
```
...
```ts
import { CreditNoteCorrectionCode, CreditNoteCorrectionCodeInfo } from "factus-js";
```
...
```ts
import { SupportDocumentIdentityTypeId, SupportDocumentIdentityTypeIdInfo } from "factus-js";
```
...
```ts
import { NumberingRangeDocumentTypeCode, NumberingRangeDocumentTypeCodeInfo } from "factus-js";
```
...
```ts
import { AdjustmentNoteReasonCode, AdjustmentNoteReasonCodeInfo } from "factus-js";
```
...
```ts
import { FiscalResponsibilityCode, FiscalResponsibilityCodeInfo } from "factus-js";
```
