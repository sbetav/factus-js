---
title: Introducción
description: Crear, consultar, descargar y gestionar facturas electrónicas usando la API de Factus.
---
...
<Callout type="info">
  ...
  [Introducción
  Facturas](https://developers.factus.com.co/v1/facturas/introduccion/index.html).
</Callout>
...
| `listAll(params?)`                          | `GET /v1/bills` _(paginación automática)_                   | Iterador async que recorre todas las páginas |
