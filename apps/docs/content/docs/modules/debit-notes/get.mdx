...
description: Obtener el detalle completo de una nota débito por numero.
---
...
Fuente oficial: [Ver nota débito](https://developers.factus.com.co/notas-debito/ver)
...
<TypeTable
  type={{
    number: {
      type: "string",
      required: true,
      description: "Número del documento de la nota débito.",
    },
  }}
/>
## Ejemplo
...
```ts
const response = await factus.debitNotes.get("ND856");
