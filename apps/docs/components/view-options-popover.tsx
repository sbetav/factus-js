// This component exists only to override the labels in `fumadocs-ui`'s
// `ViewOptionsPopover`, whose dropdown item titles are hardcoded in the library.
"use client";

import type { ComponentPropsWithoutRef, ReactNode } from "react";
import { ExternalLinkIcon, TextIcon, ChevronDown } from "lucide-react";
